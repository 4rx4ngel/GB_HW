...
data['tmp'] = 1                                         # Добавляем столбец tmp
...
data.columns = data.columns.droplevel()                 # Получаем индекс 1-го столбца и записываем его в переменную
data.columns.name = ''                                  # Переименовываем 1-ый столбец в пустую строку
print(data)
